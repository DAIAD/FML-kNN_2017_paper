...
/**
 * Created by whashnez on 26/02/16.
 * This class is where the application starts and is setup
 * to run in one of the three separate modes
 */
...
public class Setup {
    ...
    public static void main(String[] args) throws Exception {
		...
		for (int j=0; j<populationSize; j++) {
                    ...
                    try { scores[j] = app.execute(conf)[scoreElement]; }
                    catch (Exception e) {
                ...
                for (int j=topElite; j<populationSize; j++) {
                    ...
                    // Perform crossover
                        ...
                        nextGen[j] = Functions.crossover(nextGen[randomEliteElement1], nextGen[randomEliteElement2], conf);
                    }
                }
        ...
        // In case genetic algorithm execution is not required (normal/cross-validation mode), just
        // print the results
        else {
