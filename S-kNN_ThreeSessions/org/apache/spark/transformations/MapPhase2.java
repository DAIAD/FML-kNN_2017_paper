...
public class MapPhase2 implements PairFlatMapFunction<String, Tuple2<Integer, String>, Phase1_2Value> {
	...
	public MapPhase2(ExecConf conf) throws IOException {
		...
		Path rPt = new Path("hdfs://localhost:9000/user/chgeorgakidis/Rrange" + i);
                Path sPt = new Path("hdfs://localhost:9000/user/chgeorgakidis/Srange" + i);
	...
	@Override
	public Iterable<Tuple2<Tuple2<Integer, String>, Phase1_2Value>> call(String input) throws Exception {
